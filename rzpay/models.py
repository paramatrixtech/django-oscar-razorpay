...
class RazorpayTransaction(models.Model):
    ...
    basket_id = models.CharField(max_length=12, null=True, blank=True,
                                 db_index=True)
    ...
    status = models.CharField(max_length=32, choices=STATUS_CHOICES,
                              default=INITIATED)
    payment_mode = models.CharField(max_length=32, null=True, blank=True)

    rz_id = models.CharField(max_length=32, null=True, blank=True,
                             db_index=True)
    ...
    @property
    def is_failed(self):
        return self.status not in (self.CAPTURED, self.AUTHORIZED,
                                   self.INITIATED)
